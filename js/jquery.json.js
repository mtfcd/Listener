...
function hide(){
    ...
    var data_type = parentNode.getAttribute('data-type');
    var data_size = parentNode.getAttribute('data-size');
    parentNode.setAttribute('data-inner',parentNode.innerHTML);
    if (data_type === 'array') {
        parentNode.innerHTML = '<i  style="cursor:pointer;" class="fa fa-plus-square-o"></i>Array[<span class="json_number">' + data_size + '</span>]';
        for (let i of parentNode.getElementsByTagName('i')){
            i.addEventListener("click", show)
        }
    }else{
        parentNode.innerHTML = '<i  style="cursor:pointer;" class="fa fa-plus-square-o"></i>Object{...}';
        for (let i of parentNode.getElementsByTagName('i')){
            i.addEventListener("click", show)
        }
    }
...
function show(){
    let parentNode = this.parentNode;
    var innerHtml = parentNode.getAttribute('data-inner');
